...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Glow & Flow Jewelry is a modern e-commerce platform for personalized jewelry." },
      { name: "twitter:description", content: "Glow & Flow Jewelry is a modern e-commerce platform for personalized jewelry." },
