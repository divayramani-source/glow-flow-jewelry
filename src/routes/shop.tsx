...
export const Route = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [
      { title: "Shop — IcedOut" },
      { name: "description", content: "Browse premium hip-hop jewelry." },
    ],
  }),
  component: Shop,
});
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 md:px-8 py-16">
      <div className="flex flex-col gap-2 mb-10">
        <div className="text-xs uppercase tracking-[0.3em] text-[var(--rose)]">
          The Vault
        </div>
        ...
        <p className="text-muted-foreground max-w-xl">
          Every piece is hand-finished. Pick a metal at checkout.
        </p>
      </div>
        ...
        {filtered.map((p) => (
          ...
          >
            <div className="aspect-square overflow-hidden">
              <img
                src={resolveImage(p.slug, p.image_url)}
                alt={p.name}
                loading="lazy"
